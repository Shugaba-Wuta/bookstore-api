...
const TIME_TOLERANCE_FOR_OTP = 1 //Values from 0...1
...
const ALLOWED_HOST = ["http://localhost:3000", "https://localhost:3000", /books9ja\.com$/]
...
module.exports = { BOOK_CATEGORY, NIGERIAN_COMMERCIAL_BANKS, USER_FORBIDDEN_FIELDS, PRODUCT_DEPARTMENTS, PRODUCT_FORBIDDEN_FIELDS, RESULT_LIMIT, OTP_CODE_LENGTH, MAX_OTP_TIME_IN_SECONDS, TIME_TOLERANCE_FOR_OTP, SUPER_ROLES, DEFAULT_COMMISSION, DEFAULT_TAX, DOCUMENT_CATEGORY_TYPES, ALLOWED_HOST, COUPON_TYPES, PRODUCTION_ENV, DEVELOPMENT_ENV }
